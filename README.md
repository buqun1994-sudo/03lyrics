...
- 当前 Release 版本：`1.0.17-icar03` / `versionCode=131`（版本真值见 `release-version.properties`）
- Android 正式包名：`com.ninepointnine.desktoplyrics`
- Debug/staging 测试包：`com.ninepointnine.desktoplyrics.test`，版本名追加 `-test`，与正式包共用版本码
- 作者：B站 `@Tcrrrry`
